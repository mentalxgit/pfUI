...
function pfUI.uf:UpdateConfig()
  ...
  f.glow:SetPoint("TOPLEFT", f.hp.bar, "TOPLEFT", -6 - default_border,6 + default_border)
  f.glow:SetPoint("BOTTOMRIGHT", f.hp.bar, "BOTTOMRIGHT", 6 + default_border,-6 - default_border)
